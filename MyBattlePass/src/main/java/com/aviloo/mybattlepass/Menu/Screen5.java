...
public class Screen5 {
    ...
    public static Inventory inv(Player player){
        Inventory inv = Bukkit.createInventory(player,45,"Боевой пропуск (У вас 4 уровень)");

        ItemStack air = new ItemStack(Material.AIR);

        ItemStack lvl5 = new ItemStack(Material.GOLD_BLOCK, 1);
        if(BPExp.getExp(player) < 750) {
            lvl5.setType(Material.GOLD_BLOCK);
            ItemMeta lvl5meta = lvl5.getItemMeta();
            lvl5meta.setDisplayName(ChatColor.YELLOW + "Уровень 5");
            ArrayList<String> lore5 = new ArrayList<>();
            lore5.add(" ");
            lore5.add(ChatColor.GRAY+"Необходимо 750 единиц опыта.");
            lore5.add(ChatColor.GRAY+"Не хватает " + ChatColor.BLUE + BPExp.getLack(player,750));
            lore5.add(ChatColor.GRAY+"У вас сейчас " +ChatColor.LIGHT_PURPLE+ BPExp.getExp(player) +ChatColor.GRAY+" очков опыта.");
            lore5.add(" ");
            lore5.add(ChatColor.YELLOW+"Вы получите:");
            lore5.add(ChatColor.WHITE+"-"+ChatColor.LIGHT_PURPLE+" 500 Коинов");
            lore5.add(ChatColor.WHITE+"- 25 Cтейков");
            lore5.add(ChatColor.WHITE+"- 1 Золотое яблоко");
            lvl5meta.setLore(lore5);
            lvl5.setItemMeta(lvl5meta);
        }
        if(BPExp.getExp(player) >= 750){
            lvl5.setType(Material.EMERALD_BLOCK);
            ItemMeta lvl5meta = lvl5.getItemMeta();
            lvl5meta.setDisplayName(ChatColor.YELLOW + "Уровень 5");
            ArrayList<String> lore5 = new ArrayList<>();
            lore5.add(" ");
            lore5.add(ChatColor.GRAY+"Можно получить награду.");
            lore5.add(" ");
            lore5.add(ChatColor.YELLOW+"Вы получите:");
            lore5.add(ChatColor.WHITE+"-"+ChatColor.LIGHT_PURPLE+" 500 Коинов");
            lore5.add(ChatColor.WHITE+"- 25 Cтейков");
