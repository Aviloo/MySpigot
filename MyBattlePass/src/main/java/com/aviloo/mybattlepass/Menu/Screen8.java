...
public class Screen8 {
    public static Inventory inv(Player player){
        ...
        //Донат уровни
        ItemStack lvl8 = new ItemStack(Material.GOLD_BLOCK, 1);
        if(BPExp.getExp(player) < 1550) {
            lvl8.setType(Material.GOLD_BLOCK);
            ItemMeta lvl8meta = lvl8.getItemMeta();
            lvl8meta.setDisplayName(ChatColor.YELLOW + "Уровень 8");
            ArrayList<String> lore8 = new ArrayList<>();
            lore8.add(" ");
            lore8.add(ChatColor.GRAY+"Необходимо 1550 единиц опыта.");
            lore8.add(ChatColor.GRAY+"Не хватает " + ChatColor.BLUE + BPExp.getLack(player,1550));
            lore8.add(ChatColor.GRAY+"У вас сейчас " +ChatColor.LIGHT_PURPLE+ BPExp.getExp(player) +ChatColor.GRAY+" очков опыта.");
            lore8.add(" ");
            lore8.add(ChatColor.YELLOW+"Вы получите:");
            lore8.add(ChatColor.WHITE+"-"+ChatColor.LIGHT_PURPLE+" 500 Коинов");
            lore8.add(ChatColor.WHITE+"- 10 Панцирей шалкера");
            lore8.add(ChatColor.GOLD+"- Случайная награда ???");
            lvl8meta.setLore(lore8);
            lvl8.setItemMeta(lvl8meta);
        }
        if(BPExp.getExp(player) >= 1550){
            lvl8.setType(Material.EMERALD_BLOCK);
            ItemMeta lvl8meta = lvl8.getItemMeta();
            lvl8meta.setDisplayName(ChatColor.YELLOW + "Уровень 8");
            ArrayList<String> lore8 = new ArrayList<>();
            lore8.add(" ");
            lore8.add(ChatColor.GRAY+"Можно получить награду.");
            lore8.add(" ");
            lore8.add(ChatColor.YELLOW+"Вы получите:");
            lore8.add(ChatColor.WHITE+"-"+ChatColor.LIGHT_PURPLE+" 500 Коинов");
            lore8.add(ChatColor.WHITE+"- 10 Панцирей шалкера");
        ...
        if(!player.hasPermission("BattlePass.9lvl")){
            ...
            lore9.add(ChatColor.YELLOW+"игрокам имеющим статус - " +ChatColor.AQUA+"Riot");
            lore9.add(" ");
            lvl9meta.setLore(lore9);
            lvl9.setItemMeta(lvl9meta);
        }
