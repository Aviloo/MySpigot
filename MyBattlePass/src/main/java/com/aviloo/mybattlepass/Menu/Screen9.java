...
public class Screen9 {
    public static Inventory inv(Player player){
        Inventory inv = Bukkit.createInventory(player,45,"Боевой пропуск (У вас 8 уровень)");
        ...
        ItemStack lvl9 = new ItemStack(Material.GOLD_BLOCK, 1);
        if(BPExp.getExp(player) < 1950) {
            lvl9.setType(Material.GOLD_BLOCK);
            ItemMeta lvl9meta = lvl9.getItemMeta();
            lvl9meta.setDisplayName(ChatColor.YELLOW + "Уровень 9");
            ArrayList<String> lore9 = new ArrayList<>();
            lore9.add(" ");
            lore9.add(ChatColor.GRAY+"Необходимо 1950 единиц опыта.");
            lore9.add(ChatColor.GRAY+"Не хватает " + ChatColor.BLUE + BPExp.getLack(player,1950));
            lore9.add(ChatColor.GRAY+"У вас сейчас " +ChatColor.LIGHT_PURPLE+ BPExp.getExp(player) +ChatColor.GRAY+" очков опыта.");
            lore9.add(" ");
            lore9.add(ChatColor.YELLOW+"Вы получите:");
            lore9.add(ChatColor.WHITE+"-"+ChatColor.LIGHT_PURPLE+" 500 Коинов");
            lore9.add(ChatColor.WHITE+"- 64 Баночки с опытом");
            lore9.add(ChatColor.GOLD+"- Случайная награда ???");
            lvl9meta.setLore(lore9);
            lvl9.setItemMeta(lvl9meta);
        }
        if(BPExp.getExp(player) >= 1950){
            lvl9.setType(Material.EMERALD_BLOCK);
            ItemMeta lvl9meta = lvl9.getItemMeta();
            lvl9meta.setDisplayName(ChatColor.YELLOW + "Уровень 9");
            ArrayList<String> lore9 = new ArrayList<>();
            lore9.add(" ");
            lore9.add(ChatColor.GRAY+"Можно получить награду.");
            lore9.add(" ");
            lore9.add(ChatColor.YELLOW+"Вы получите:");
            lore9.add(ChatColor.WHITE+"-"+ChatColor.LIGHT_PURPLE+" 500 Коинов");
            lore9.add(ChatColor.WHITE+"- 64 Баночки с опытом");
        ...
        ItemStack[] inv_stack = {air,air,air,air,top,air,air,air,air,
                ...
                air,air,air,lvl8,lvl9,air,air,air,air,
