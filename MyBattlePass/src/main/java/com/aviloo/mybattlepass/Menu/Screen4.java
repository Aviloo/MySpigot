...
public class Screen4 {
    public static Inventory inv(Player player) {
        Inventory inv = Bukkit.createInventory(player, 45, "Боевой пропуск (У вас 3 уровень)");
        ...
        ItemStack lvl4 = new ItemStack(Material.GOLD_BLOCK, 1);
        if(BPExp.getExp(player) < 550) {
            lvl4.setType(Material.GOLD_BLOCK);
            ItemMeta lvl4meta = lvl4.getItemMeta();
            lvl4meta.setDisplayName(ChatColor.YELLOW + "Уровень 4");
            ArrayList<String> lore4 = new ArrayList<>();
            lore4.add(" ");
            lore4.add(ChatColor.GRAY+"Необходимо 550 единиц опыта.");
            lore4.add(ChatColor.GRAY+"Не хватает " + ChatColor.BLUE + BPExp.getLack(player,550));
            lore4.add(ChatColor.GRAY+"У вас сейчас " +ChatColor.LIGHT_PURPLE+ BPExp.getExp(player) +ChatColor.GRAY+" очков опыта.");
            lore4.add(" ");
            lore4.add(ChatColor.YELLOW+"Вы получите:");
            lore4.add(ChatColor.WHITE+"- 7 алмазов");
            lore4.add(ChatColor.WHITE+"- 1 зачарованное золотое яблоко");
            lore4.add(ChatColor.WHITE+"- 40 дубовых бревен");
            lvl4meta.setLore(lore4);
            lvl4.setItemMeta(lvl4meta);
        }
        if(BPExp.getExp(player) >= 550){
            lvl4.setType(Material.EMERALD_BLOCK);
            ItemMeta lvl4meta = lvl4.getItemMeta();
            lvl4meta.setDisplayName(ChatColor.YELLOW + "Уровень 4");
            ArrayList<String> lore4 = new ArrayList<>();
            lore4.add(" ");
            lore4.add(ChatColor.GRAY+"Можно получить награду.");
            lore4.add(" ");
            lore4.add(ChatColor.YELLOW+"Вы получите:");
            lore4.add(ChatColor.WHITE+"- 7 алмазов");
            lore4.add(ChatColor.WHITE+"- 1 зачарованное золотое яблоко");
