...
public class Screen1 {
    ...
    public static Inventory inv(Player player){
        Inventory inv = Bukkit.createInventory(player,45,"Боевой пропуск (У вас 0 уровень)");
        ...
        ItemStack lvl1 = new ItemStack(Material.GOLD_BLOCK, 1);
        if(BPExp.getExp(player) < 100) {
            lvl1.setType(Material.GOLD_BLOCK);
            ItemMeta lvl1meta = lvl1.getItemMeta();
            lvl1meta.setDisplayName(ChatColor.YELLOW + "Уровень 1");
            ArrayList<String> lore1 = new ArrayList<>();
            lore1.add(" ");
            lore1.add(ChatColor.GRAY+"Необходимо 100 единиц опыта.");
            lore1.add(ChatColor.GRAY+"Не хватает " + ChatColor.BLUE + BPExp.getLack(player,100));
            lore1.add(ChatColor.GRAY+"У вас сейчас " +ChatColor.LIGHT_PURPLE+ BPExp.getExp(player) +ChatColor.GRAY+" очков опыта.");
            lore1.add(" ");
            lore1.add(ChatColor.YELLOW+"Вы получите:");
            lore1.add(ChatColor.WHITE+"- 5 Алмазов");
            lore1.add(ChatColor.WHITE+"- 5 Cтейков");
            lore1.add(ChatColor.WHITE+"- 1 Золотое яблоко");
            lvl1meta.setLore(lore1);
            lvl1.setItemMeta(lvl1meta);
        }
        if(BPExp.getExp(player) >= 100){
            lvl1.setType(Material.EMERALD_BLOCK);
            ItemMeta lvl1meta = lvl1.getItemMeta();
            lvl1meta.setDisplayName(ChatColor.YELLOW + "Уровень 1");
            ArrayList<String> lore1 = new ArrayList<>();
            lore1.add(" ");
            lore1.add(ChatColor.GRAY+"Можно получить награду.");
            lore1.add(" ");
            lore1.add(ChatColor.YELLOW+"Вы получите:");
            lore1.add(ChatColor.WHITE+"- 5 Алмазов");
            lore1.add(ChatColor.WHITE+"- 5 Cтейков");
        ...
        lore2.add(" ");
        lore2.add(ChatColor.WHITE+"Чтобы получить доступ,");
        lore2.add(ChatColor.WHITE+"выполните предыдущее задание.");
        ...
        lore3.add(" ");
        lore3.add(ChatColor.WHITE+"Чтобы получить доступ,");
        lore3.add(ChatColor.WHITE+"выполните предыдущее задание.");
        ...
        lore4.add(" ");
        lore4.add(ChatColor.WHITE+"Чтобы получить доступ,");
        lore4.add(ChatColor.WHITE+"выполните предыдущее задание.");
        ...
        lore5.add(" ");
        lore5.add(ChatColor.WHITE+"Чтобы получить доступ,");
        lore5.add(ChatColor.WHITE+"выполните предыдущее задание.");
        lvl5meta.setLore(lore5);
        lvl5.setItemMeta(lvl5meta);

        ItemStack lvl6 = new ItemStack(Material.COAL_BLOCK,1);
        ItemMeta lvl6meta = lvl6.getItemMeta();
        lvl6meta.setDisplayName(ChatColor.YELLOW + "Уровень 6");
        ArrayList<String> lore6 = new ArrayList<>();
        lore6.add(" ");
        lore6.add(ChatColor.WHITE+"Чтобы получить доступ,");
        lore6.add(ChatColor.WHITE+"выполните предыдущее задание.");
