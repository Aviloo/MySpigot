...
public class Screen3 {
    ...
    public static Inventory getInv(Player player){
        Inventory inv = Bukkit.createInventory(player,45,"Боевой пропуск  (У вас 2 уровень)");
        ...
        ItemStack lvl3 = new ItemStack(Material.GOLD_BLOCK, 1);
        if(BPExp.getExp(player) < 400) {
            lvl3.setType(Material.GOLD_BLOCK);
            ItemMeta lvl3meta = lvl3.getItemMeta();
            lvl3meta.setDisplayName(ChatColor.YELLOW + "Уровень 3");
            ArrayList<String> lore3 = new ArrayList<>();
            lore3.add(" ");
            lore3.add(ChatColor.GRAY+"Необходимо 400 единиц опыта.");
            lore3.add(ChatColor.GRAY+"Не хватает " + ChatColor.BLUE + BPExp.getLack(player,400));
            lore3.add(ChatColor.GRAY+"У вас сейчас " +ChatColor.LIGHT_PURPLE+ BPExp.getExp(player) +ChatColor.GRAY+" очков опыта.");
            lore3.add(" ");
            lore3.add(ChatColor.YELLOW+"Вы получите:");
            lore3.add(ChatColor.WHITE+"- 5 алмазов");
            lore3.add(ChatColor.WHITE+"- 1 семечко какао-бобов");
            lore3.add(ChatColor.WHITE+"- 25 стэйков");
            lvl3meta.setLore(lore3);
            lvl3.setItemMeta(lvl3meta);
        }
        if(BPExp.getExp(player) >= 400){
            lvl3.setType(Material.EMERALD_BLOCK);
            ItemMeta lvl3meta = lvl3.getItemMeta();
            lvl3meta.setDisplayName(ChatColor.YELLOW + "Уровень 3");
            ArrayList<String> lore3 = new ArrayList<>();
            lore3.add(" ");
            lore3.add(ChatColor.GRAY+"Можно получить награду.");
            lore3.add(" ");
            lore3.add(ChatColor.YELLOW+"Вы получите:");
            lore3.add(ChatColor.WHITE+"- 32 железа");
            lore3.add(ChatColor.WHITE+"- 10 кроличьих лап");
            lore3.add(ChatColor.WHITE+"- 16 единиц редстоуна");
            lvl3meta.setLore(lore3);
            lvl3.setItemMeta(lvl3meta);
        }
