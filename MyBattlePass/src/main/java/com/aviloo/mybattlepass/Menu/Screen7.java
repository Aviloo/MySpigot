...
public class Screen7 {
    public static Inventory inv(Player player){
        Inventory inv = Bukkit.createInventory(player,45,"Боевой пропуск (У вас 6 уровень)");

        ItemStack air = new ItemStack(Material.AIR);

        ItemStack lvl7 = new ItemStack(Material.GOLD_BLOCK, 1);
        if(BPExp.getExp(player) < 1300) {
            lvl7.setType(Material.GOLD_BLOCK);
            ItemMeta lvl7meta = lvl7.getItemMeta();
            lvl7meta.setDisplayName(ChatColor.YELLOW + "Уровень 7");
            ArrayList<String> lore7 = new ArrayList<>();
            lore7.add(" ");
            lore7.add(ChatColor.GRAY+"Необходимо 1300 единиц опыта.");
            lore7.add(ChatColor.GRAY+"Не хватает " + ChatColor.BLUE + BPExp.getLack(player,1300));
            lore7.add(ChatColor.GRAY+"У вас сейчас " +ChatColor.LIGHT_PURPLE+ BPExp.getExp(player) +ChatColor.GRAY+" очков опыта.");
            lore7.add(" ");
            lore7.add(ChatColor.YELLOW+"Вы получите:");
            lore7.add(ChatColor.WHITE+"-"+ChatColor.LIGHT_PURPLE+" 700 Коинов");
            lore7.add(ChatColor.WHITE+"- 10 Панцирей шалкера");
            lore7.add(ChatColor.GOLD+"- Случайная награда ???");
            lvl7meta.setLore(lore7);
            lvl7.setItemMeta(lvl7meta);
        }
        if(BPExp.getExp(player) >= 1300){
            lvl7.setType(Material.EMERALD_BLOCK);
            ItemMeta lvl7meta = lvl7.getItemMeta();
            lvl7meta.setDisplayName(ChatColor.YELLOW + "Уровень 7");
            ArrayList<String> lore7 = new ArrayList<>();
            lore7.add(" ");
            lore7.add(ChatColor.GRAY+"Можно получить награду.");
            lore7.add(" ");
            lore7.add(ChatColor.YELLOW+"Вы получите:");
            lore7.add(ChatColor.WHITE+"-"+ChatColor.LIGHT_PURPLE+" 700 Коинов");
            lore7.add(ChatColor.WHITE+"- 10 Панцирей шалкера");
