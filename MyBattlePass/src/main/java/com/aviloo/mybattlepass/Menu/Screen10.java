...
public class Screen10 {
    public static Inventory inv(Player player){
        Inventory inv = Bukkit.createInventory(player,45,"Боевой пропуск (У вас 9 уровень)");
        ...
        lore7.add(" ");
        lore7.add(ChatColor.WHITE+"Вы уже выполнили это задание.");
        ...
        lore6.add(" ");
        lore6.add(ChatColor.WHITE+"Вы уже выполнили это задание.");
        ...
        //Донат уровни
        ItemStack lvl8 = new ItemStack(Material.COAL_BLOCK,1);
        ItemMeta lvl8meta = lvl8.getItemMeta();
        lvl8meta.setDisplayName(ChatColor.YELLOW + "Уровень 8");
        ArrayList<String> lore8 = new ArrayList<>();
        lore8.add(" ");
        lore8.add(ChatColor.WHITE+"Вы уже выполнили это задание.");
        lvl8meta.setLore(lore8);
        lvl8.setItemMeta(lvl8meta);

        ItemStack lvl10 = new ItemStack(Material.GOLD_BLOCK, 1);
        if(BPExp.getExp(player) < 2350) {
            lvl10.setType(Material.GOLD_BLOCK);
            ...
            lore10.add(" ");
            lore10.add(ChatColor.GRAY+"Необходимо 2350 единиц опыта.");
            lore10.add(ChatColor.GRAY+"Не хватает " + ChatColor.BLUE + BPExp.getLack(player,2350));
            lore10.add(ChatColor.GRAY+"У вас сейчас " +ChatColor.LIGHT_PURPLE+ BPExp.getExp(player) +ChatColor.GRAY+" очков опыта.");
            lore10.add(" ");
            lore10.add(ChatColor.YELLOW+"Вы получите:");
            lore10.add(ChatColor.WHITE+"-"+ChatColor.LIGHT_PURPLE+" 700 Коинов");
            lore10.add(ChatColor.WHITE+"- 64 Баночки с опытом");
            lore10.add(ChatColor.WHITE+"- 10 зелье восстановления здоровья");
            lore10.add(ChatColor.GOLD+"- Случайная награда ???");
            lvl10meta.setLore(lore10);
            lvl10.setItemMeta(lvl10meta);
        }
        if(BPExp.getExp(player) >= 2350){
            lvl10.setType(Material.EMERALD_BLOCK);
            ItemMeta lvl10meta = lvl10.getItemMeta();
            lvl10meta.setDisplayName(ChatColor.YELLOW + "Уровень 10");
            ArrayList<String> lore10 = new ArrayList<>();
            lore10.add(" ");
            lore10.add(ChatColor.GRAY+"Можно получить награду.");
            lore10.add(" ");
            lore10.add(ChatColor.YELLOW+"Вы получите:");
            lore10.add(ChatColor.WHITE+"-"+ChatColor.LIGHT_PURPLE+" 500 Коинов");
            lore10.add(ChatColor.WHITE+"- 64 Баночки с опытом");
            lore10.add(ChatColor.GOLD+"- Случайная награда ???");
            lvl10meta.setLore(lore10);
            lvl10.setItemMeta(lvl10meta);
