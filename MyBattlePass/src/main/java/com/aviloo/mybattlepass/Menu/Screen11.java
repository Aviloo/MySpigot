...
public class Screen11 {
    public static Inventory inv(Player player){
        Inventory inv = Bukkit.createInventory(player,45,"Боевой пропуск (У вас 10 уровень )");
        ...
        ItemStack lvl10 = new ItemStack(Material.COAL_BLOCK,1);
        ...
        lore10.add(" ");
        lore10.add(ChatColor.WHITE+"Вы уже выполнили это задание.");
