...
public class Screen2 {
    ...
    public static Inventory getInv(Player player){
        Inventory inv = Bukkit.createInventory(player,45,"Боевой пропуск (У вас 1 уровень)");
        ...
        ItemStack lvl2 = new ItemStack(Material.GOLD_BLOCK, 1);
        if(BPExp.getExp(player) < 250) {
            ...
            lore2.add(" ");
            lore2.add(ChatColor.GRAY+"Необходимо 250 единиц опыта.");
            lore2.add(ChatColor.GRAY+"Не хватает " + ChatColor.BLUE + BPExp.getLack(player,250));
            lore2.add(ChatColor.GRAY+"У вас сейчас " +ChatColor.LIGHT_PURPLE+ BPExp.getExp(player) +ChatColor.GRAY+" очков опыта.");
            lore2.add(" ");
            lore2.add(ChatColor.YELLOW+"Вы получите:");
            lore2.add(ChatColor.WHITE+"- 32 железа");
            lore2.add(ChatColor.WHITE+"- 10 кроличьих лап");
            lore2.add(ChatColor.WHITE+"- 16 единиц редстоуна");
            lvl2meta.setLore(lore2);
            lvl2.setItemMeta(lvl2meta);
        }
        if(BPExp.getExp(player) >= 250){
            lvl2.setType(Material.EMERALD_BLOCK);
            ItemMeta lvl2meta = lvl2.getItemMeta();
            lvl2meta.setDisplayName(ChatColor.YELLOW + "Уровень 2");
            ArrayList<String> lore2 = new ArrayList<>();
            lore2.add(" ");
            lore2.add(ChatColor.GRAY+"Можно получить награду.");
            lore2.add(" ");
            lore2.add(ChatColor.YELLOW+"Вы получите:");
            lore2.add(ChatColor.WHITE+"- 32 железа");
            lore2.add(ChatColor.WHITE+"- 10 кроличьих лап");
