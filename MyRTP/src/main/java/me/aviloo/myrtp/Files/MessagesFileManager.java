...
public class MessagesFileManager {
    ...
    private MyRTP plugin;
    private FileConfiguration dataConfig = null;
    private File configFile = null;

    Logger logger = MyRTP.getPlugin().getLogger();

    public void MessagesFileManager(MyRTP plugin){
        this.plugin = plugin;
    ...
    public void saveMessagesConfig() {
        ...
        try {
            ...
            logger.severe(ColorUtils.translateColorCodes("&6MyRTP: &4Could not save messages.yml"));
            logger.severe(ColorUtils.translateColorCodes("&6MyRTP: &4Check the below message for the reasons!"));
            e.printStackTrace();
        }
    }
