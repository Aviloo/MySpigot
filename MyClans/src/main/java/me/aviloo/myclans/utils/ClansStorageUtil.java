...
import me.aviloo.myclans.api.ClanDisbandEvent;
import me.aviloo.myclans.api.ClanOfflineDisbandEvent;
import me.aviloo.myclans.api.ClanTransferOwnershipEvent;
...
public class ClansStorageUtil {
    ...
    private static final Logger logger = MyClans.getPlugin().getLogger();

    private static final Pattern STRIP_COLOR_PATTERN = Pattern.compile("(?i)" + String.valueOf('&') + "[0-9A-FK-OR]");

    private static Map<UUID, Clan> clansList = new HashMap<>();

    private static final FileConfiguration clansStorage = MyClans.getPlugin().clansFileManager.getClansConfig();
    private static final FileConfiguration messagesConfig = MyClans.getPlugin().messagesFileManager.getMessagesConfig();
    private static final FileConfiguration clansConfig = MyClans.getPlugin().getConfig();
    ...
    public static void saveClans() throws IOException {
        ...
        MyClans.getPlugin().clansFileManager.saveClansConfig();
    }
