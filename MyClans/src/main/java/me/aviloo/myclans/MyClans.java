package me.aviloo.myclans;

import com.rylinaux.plugman.api.PlugManAPI;
import com.tcoded.folialib.FoliaLib;
import io.papermc.lib.PaperLib;
import me.aviloo.myclans.commands.*;
import me.aviloo.myclans.commands.commandTabCompleters.ClanAdminTabCompleter;
import me.aviloo.myclans.commands.commandTabCompleters.ClanCommandTabCompleter;
import me.aviloo.myclans.expansions.PlayerClanExpansion;
import me.aviloo.myclans.files.ClanGUIFileManager;
import me.aviloo.myclans.files.ClansFileManager;
import me.aviloo.myclans.files.MessagesFileManager;
import me.aviloo.myclans.files.UsermapFileManager;
import me.aviloo.myclans.listeners.*;
import me.aviloo.myclans.menuSystem.PlayerMenuUtility;
import me.aviloo.myclans.menuSystem.paginatedMenu.ClanListGUI;
import me.aviloo.myclans.updateSystem.JoinEvent;
import me.aviloo.myclans.updateSystem.UpdateChecker;
import me.aviloo.myclans.utils.*;
...
public final class MyClans extends JavaPlugin{
    ...
    public void onEnable() {
        ...
        //Register api (Vault) events
        setupEconomy();
        this.getServer().getPluginManager().registerEvents(new EconomyManager(this),this);
    ...
    public static MyClans getPlugin() {
        return plugin;
    }
