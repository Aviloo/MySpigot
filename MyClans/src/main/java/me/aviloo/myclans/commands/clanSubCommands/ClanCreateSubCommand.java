...
import me.aviloo.myclans.api.ClanCreateEvent;
...
import me.aviloo.myclans.utils.EconomyManager;
    ...
    public boolean createClanSubCommand(CommandSender sender, String[] args, List<String> bannedTags) {
        if (sender instanceof Player) {
            ...
            if (args.length >= 2) {
                ...
                //Vault Part
                if(!EconomyManager.hasPlayerMoney(player,7000.0)){
                    return true;
                }
                //Other Part
                ...
                if (args[1].length() < MIN_CHAR_LIMIT) {
                    ...
                    if (!ClansStorageUtil.isClanExisting(player)) {
                        ...
                        //Vault Part
                        EconomyManager.takeMoney(player,7000.0);
                        //Other Part
