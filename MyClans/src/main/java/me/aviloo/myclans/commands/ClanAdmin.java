...
//----------------------------------------------------------------------------------------------------------------------
                if (args[0].equalsIgnoreCase("reload")) {
                    ...
                    MyClans plugin = MyClans.getPlugin();
                    plugin.onDisable();
                    ...
                    foliaLib.getImpl().runLater(new Runnable() {
                        @Override
                        public void run() {
                            MyClans.getPlugin().reloadConfig();
                            ClanCommand.updateBannedTagsList();
                            MyClans.getPlugin().messagesFileManager.reloadMessagesConfig();
                            MyClans.getPlugin().clanGUIFileManager.reloadClanGUIConfig();
...
//----------------------------------------------------------------------------------------------------------------------
                if (args[0].equalsIgnoreCase("about")) {
                    ...
                    sender.sendMessage(ColorUtils.translateColorCodes("&3Version: &6" + MyClans.getPlugin().getDescription().getVersion()));
                    sender.sendMessage(ColorUtils.translateColorCodes("&3Authors: &6" + MyClans.getPlugin().getDescription().getAuthors()));
                    sender.sendMessage(ColorUtils.translateColorCodes("&3Description: &6" + MyClans.getPlugin().getDescription().getDescription()));
                    sender.sendMessage(ColorUtils.translateColorCodes("&3Website: "));
                    sender.sendMessage(ColorUtils.translateColorCodes("&6" + MyClans.getPlugin().getDescription().getWebsite()));
...
//----------------------------------------------------------------------------------------------------------------------
                if (args[0].equalsIgnoreCase("about")) {
                    ...
                    logger.info(ColorUtils.translateColorCodes("&3Version: &6" + MyClans.getPlugin().getDescription().getVersion()));
                    logger.info(ColorUtils.translateColorCodes("&3Authors: &6" + MyClans.getPlugin().getDescription().getAuthors()));
                    logger.info(ColorUtils.translateColorCodes("&3Description: &6" + MyClans.getPlugin().getDescription().getDescription()));
                    logger.info(ColorUtils.translateColorCodes("&3Website: "));
                    logger.info(ColorUtils.translateColorCodes("&6" + MyClans.getPlugin().getDescription().getWebsite()));
